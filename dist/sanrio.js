    ...
    for (let i = 0; i < level.length; i++){
        switch (level[i]){
            ...
            case 'G':
                break;
            case 'c':
                deco.push(new _scene_coin__WEBPACK_IMPORTED_MODULE_4__["default"](width, height - _constants__WEBPACK_IMPORTED_MODULE_1__["HEIGHTSPAN"]));
